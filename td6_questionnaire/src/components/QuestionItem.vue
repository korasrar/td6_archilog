...
const startEdit = () => {
  if (props.readonly) return; // Bloquer si readonly
  ...
  editData.value = {
    ...
    bonne_reponse:
      ...
      props.question.BonneReponse ||
      props.question.bonne_reponse,
    ...
    <div class="card-body">
      <div v-if="isEditing">
        ...
        <div v-if="editData.type === 'question_ouverte'" class="mb-3">
          ...
          <input
            v-model="editData.bonne_reponse"
            type="text"
            class="form-control"
          />
        </div>
        ...
        <button class="btn btn-primary me-2" @click="saveEdit">
          Sauvegarder
        </button>
      ...
      <div v-else>
        <h5 class="card-title">
          N°{{ question.numero }} - {{ question.enonce }}
        </h5>
        ...
        <div v-if="question.type === 'question_fermee'">
          <p class="card-text mb-1">
            <strong>Prop 1 :</strong>
            {{ question.Proposition1 || question.proposition1 }}
          </p>
          <p class="card-text mb-1">
            <strong>Prop 2 :</strong>
            {{ question.Proposition2 || question.proposition2 }}
          </p>
          <p class="card-text">
            <strong>Bonne rep :</strong>
            {{ question.BonneReponse || question.bonne_reponse }}
          </p>
        </div>
        ...
        <div v-if="!readonly" class="mt-3">
          ...
          <button class="btn btn-danger" @click="$emit('delete', question.id)">
            Supprimer
          </button>
        </div>
      </div>
